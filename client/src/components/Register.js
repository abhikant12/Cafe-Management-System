        ...
        <div className="card-content">
          ...
          <div className="row">
            <form className="col s12 m6 offset-m3" onSubmit={onSubmit}>
              ...
              <div className="input-field">
                <input type="password" name="password" minLength="8" required values={password} onChange={onChange} />            
                <label htmlFor="password">Password</label>
              </div>
              <div className="input-field">
                <input type="password"  name="confirmPassword" minLength="8" required value={confirmPassword}  onChange={onChange} />
                <label htmlFor="name">Confirm Password</label>
              </div>
              <div className="input-field">
                <select required value={role} onChange={handleSelectChange}>
                  <option value="null" defaultValue> Choose your option </option>
                  <option value="restaurant">Cafeteria Manager</option>
                  <option value="user">Consumer</option>
                </select>
                <label>Apply as</label>
              </div>
              <button className="btn waves-effect teal darken-3 submitBtn"  type="submit" value="Register" >
                Register
              </button>
            </form>
            <div className="row">
